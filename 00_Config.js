...
// ⚙️ MÓDULO DE CONTROLE GERAL (AGENDAMENTOS)
const ID_PLANILHA_VIGENTE = "1mq4LbjTMySJmtSOfp8mczE9iHU9S4oPGKlrKXO6p9fQ";
const ID_PLANILHA_HISTORICO = "1vkf3dgvxHXYZawFO6qCD3K93yE21wsNCeDY1TlxzGm4";

const MAPA_AGENDAMENTO = {
  SERVICO: 2,           // Coluna B
  NOME: 3,              // Coluna C
  PLACA: 4,             // Coluna D
  IMEI: 5,              // Coluna E
  DATA_ENVIO_TERMO: 6,  // Coluna F
  DATA_CONCLUSAO: 7,    // Coluna G
  TECNICO: 8,           // Coluna H
  REGIAO: 9,            // Coluna I
  VOLUNTARIO: 10,       // Coluna J
  VALOR_FIPE: 11,       // Coluna K
  FIPE_TIPO: 12,        // Coluna L
  USUARIO_INCLUIU: 13,  // Coluna M
  USUARIO_CONCLUIU: 14, // Coluna N
  SITUACAO: 15,         // Coluna O
  DATA_AGENDAMENTO: 16, // Coluna P
  TURNO: 17             // Coluna Q
};
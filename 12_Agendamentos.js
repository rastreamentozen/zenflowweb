...
function web_salvarNovoAgendamento(obj) {
  try {
    ...
    // 5. Preenche os campos de acordo com as coordenadas do seu Config
    ...
    if (MAPA_AGENDAMENTO.VOLUNTARIO) novaLinha[MAPA_AGENDAMENTO.VOLUNTARIO - 1] = obj.voluntario;
    if (MAPA_AGENDAMENTO.TECNICO) novaLinha[MAPA_AGENDAMENTO.TECNICO - 1] = obj.tecnico;
    if (MAPA_AGENDAMENTO.IMEI) novaLinha[MAPA_AGENDAMENTO.IMEI - 1] = obj.imei;
